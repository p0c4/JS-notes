...
// chain test grades ternary operators example
let testScore =89;
...
let playerTwo = "rock";
let comp = "scissors";
let result = playerTwo === comp ?
    "Tie game!"
    : playerTwo === "rock" && comp === "paper"
    ? "Computer wins!"
    : playerTwo === "paper" && comp === "scissors"
    ? "Computer wins!"
    : playerTwo === "scissors" && comp === "rock"
    ? "Computer wins!"
    : "playerTwo wins";
console.log(result);